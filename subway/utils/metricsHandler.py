...
class MetricsHandler():
    '''
        MetricsHandler class computes various metrics of the subway system and plots the metrics
    '''
    ...
    def computeAvgDeg(self):
        ...
        '''
        deg_sum = sum([self.computeNodeDeg(node) for node in self.station_list])
